...
plot [1.5:2.5][0.0:1.5] 'relError$1.dat' u 1:4:5 title 'exact' with yerrorbars, 'averaged$1.dat' u 1:4 title 'simu' with line, 'relError$1.dat' u 1:5 axes x1y2 title 'error'with line;
...
plot [1.5:2.5][0.0:1.3] 'relError$1.dat' u 1:2:3 title 'exact' with yerrorbars, 'averaged$1.dat' u 1:3 title 'simu' with line, 'relError$1.dat' u 1:3 axes x1y2 title 'error'with line;
...
plot [1.5:2.5][0.0:1.1] 'relError$1.dat' u 1:6:7 title 'exact'with line , 'averaged$1.dat' u 1:5 title 'simu' with line, 'relError$1.dat' u 1:7 axes x1y2 title 'error'with line;
...
plot [1.5:2.5][0.0:4.0] 'relError$1.dat' u 1:8:9 title 'exact' with yerrorbars, 'averaged$1.dat' u 1:6 title 'simu' with line, 'relError$1.dat' u 1:9 axes x1y2 title 'error' with line;
