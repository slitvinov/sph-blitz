...
set material_sound_speed(0) 30.0
...
if  [catch {set OUTDIR outdata-per${eta_block}-p${g_all}vsound$material_sound_speed(0)xncell${xncell}niter${s1_niter}-$material_gamma(0)k_rho${k_rho}rnd}] {
    set OUTDIR outdata0
    set eta_block 1.0
} 
