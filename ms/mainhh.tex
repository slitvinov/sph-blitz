...
\end{table}
 ...
 The same resolution study as for method 1 has been conducted for method 2 to investigate possible differences in their convergence behaviour. 
...
When a small ratio $l_s/dx$ is sufficient for a certain simulation configuration and the number of(thi) the boundary representation is also more exact and, as it makes no difference anyway, the simple method with constant quantity for ghost particles may be used, which saves some calculation time.
