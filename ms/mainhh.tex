...
\centering
\subfigure[]{
\includegraphics[width=5cm,height=6cm]{Resultats/H2-N2O/Delais/DelaisHydroOxyPetersen.eps}}
\subfigure[]{
\includegraphics[width=5cm,height=6cm]{Resultats/H2-N2O/Delais/DelaisHydroOxyHidaka.eps}}
\subfigure[]{
\includegraphics[width=5cm,height=6cm]{Resultats/H2-N2O/Delais/DelaisHydroOxySkinner.eps}}
\subfigure[]{
\includegraphics[width=5cm,height=6cm]{Resultats/H2-N2O/Delais/DelaisHydroOxyWang.eps}}

\caption[Comparaison entre les prédictions du modèle et les délais
d'auto-inflamma\-tion expérimentaux obtenus en tube à choc pour des
mélanges H$_{2}$-O$_{2}$- Di\-luant]{\small Comparaison entre les
prédictions du modèle et les délais d'auto-inflammation expérimentaux
obtenus en tube à choc pour des mélanges H$_{2}$-O$_{2}$-Diluant. Traits
pleins : prédictions du modèle. a) : Petersen \cite{Petersen9}. b) :
Hidaka \cite{Hidaka3}. c) : Skinner-Schott \cite{Skinner1,Schott1}. d) :
Wang \cite{Wang1}. e) : Slack \cite{Slack1}.\\}
\label{DelaisHydroOxy}
\end{figure}
