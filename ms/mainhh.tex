...
\caption[Perturbation influence shock-tube with 1D constant spacing particle distribution]{L--norm errors of $\rho, u, e$ for a series of simulation with increasing perturbation of initial particle position based on a 1D constant spacing configuration. Explanation on the meaning of the different areas is given in section (\ref{sec:2Dshock_simuSetup&Co}).}
...
\caption[Perturbation influence shock-tube with 1D constant mass particle distribution]{L--norm errors of $\rho, u, e$ for a series of simulation with increasing perturbation of initial particle position based on a 1D constant mass configuration. Explanation on the meaning of the different areas is given in section (\ref{sec:2Dshock_simuSetup&Co}).}
