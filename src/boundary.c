...
struct Boundary *boundary_ini(struct Initiation *ini)
{
    int n;
...
int boundary_build(struct Boundary *q, struct List ***c, struct Material *mtl)
{
    int i, j;
...
int boundary_condition(struct Boundary *q, struct List ***c)
{
    int i, j;
    int kb, ku, mb, mu;
...
int boundary_w(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBl) {
    case 0:
	prtl->R[X] = - prtl->R[X];
...
int boundary_e(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBr) {
    case 0:
...
int boundary_s(struct Boundary *q, struct Particle *prtl)
{
    switch(q->yBd) {
    case 0:
	prtl->R[Y] = - prtl->R[Y];
...
int boundary_n(struct Boundary *q, struct Particle *prtl)
{
    switch(q->yBu) {
    case 0:
...
int boundary_sw(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBl) {
    case 0:
	prtl->R[X] = - prtl->R[X];
...
int boundary_nw(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBl) {
    case 0:
	prtl->R[X] = - prtl->R[X];
...
int boundary_ne(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBr) {
    case 0:
	prtl->R[X] = q->box_size[X]*2.0 - prtl->R[X];
...
int boundary_se(struct Boundary *q, struct Particle *prtl)
{
    switch(q->xBr) {
    case 0:
	prtl->R[X] = q->box_size[X]*2.0 - prtl->R[X];
...
int boundary_check(struct Boundary *q, struct List *list)
{
    LIST *p;
    struct Particle *prtl;
    double *box_size;
