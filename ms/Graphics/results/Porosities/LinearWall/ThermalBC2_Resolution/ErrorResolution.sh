...
plot [30:200][:] 'ErrorResolution.dat' u 1:2 title 'L_1 error' with linespoints lw 8, 'ErrorResolution.dat' u 1:3 title 'L_2 error' with linespoints lw 8,'ErrorResolution.dat' u 1:4 title 'L_inf error' with linespoints lw 8, '2nd_Order.dat' u 1:2 notitle with line lt -1 lw 0.1;
