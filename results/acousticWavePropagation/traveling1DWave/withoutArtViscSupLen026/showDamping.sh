...
plot [:][0.0:1.2] 'peakVelocities.dat' u 1:3 title '' with linespoints lw 3;
...
plot [:][0.0:1.2] 'DampingPeriod.dat' u 1:3 title '' with linespoints lw 3;
...
plot [:][-1.0:1.0] 'DampingPeriod.dat' u 1:2 title '' with linespoints lw 3;
