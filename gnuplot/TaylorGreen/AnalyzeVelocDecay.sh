...
plot [0.0:0.000005][0.0:0.04] 'decayAnalysis.dat' u 1:2 title 'exact' with line, 'decayAnalysis.dat' u 1:3 title 'simu' with points,'decayAnalysis.dat' u 1:4 axes x1y2 title 'error' with line;
