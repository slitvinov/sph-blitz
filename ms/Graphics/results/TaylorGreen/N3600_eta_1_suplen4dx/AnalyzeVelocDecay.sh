...
plot [0.0:0.1][0.0:1.0] 'decayAnalysis.dat' u 1:3 title 'Simulation' with line lw 8, 'decayAnalysis.dat' u 1:2 title 'Exact' with line lw 8, 'decayAnalysis.dat' u 1:4 title 'Error' with line lw 8;
