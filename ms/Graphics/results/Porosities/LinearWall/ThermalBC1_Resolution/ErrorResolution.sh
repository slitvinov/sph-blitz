...
plot [30:200][:] 'ErrorResolution.dat' u 1:2 title 'L_1 error' with linespoints lw 3, 'ErrorResolution.dat' u 1:3 title 'L_2 error' with linespoints lw 3,'ErrorResolution.dat' u 1:4 title 'L_inf error' with linespoints lw 3;
