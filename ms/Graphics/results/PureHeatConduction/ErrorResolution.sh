...
plot [30:250][0.00001:0.08] 'ErrorResolution.dat' u 1:2 title 'L_1 error' with linespoints lw 3, 'ErrorResolution.dat' u 1:3 title 'L_2 error' with linespoints lw 3,'ErrorResolution.dat' u 1:4 title 'L_{inf} error' with linespoints lw 3;
