...
Neglecting the so called rotational viscosity, an expression for the continuous formulation of the viscous force (respective acceleration in this case) with spatially constant viscosity is given by equation (\ref{eq:continuousViscousExpression_const}) \cite{deGroot1962}
\begin{equation}
...
\includegraphics[width=5.7cm,height=5cm]{Graphics/results/1DCode/velocity}}
\subfigure[]{
\label{fig:1DSPHreultsDensity}
\includegraphics[width=5.7cm,height=5cm]{Graphics/results/1DCode/density}}
\subfigure[]{
\label{fig:1DSPHreultsPressure}
\includegraphics[width=5.7cm,height=5cm]{Graphics/results/1DCode/pressure}}
\subfigure[]{
\label{fig:1DSPHreultsEnergy}
\includegraphics[width=5.7cm,height=5cm]{Graphics/results/1DCode/energy}}
