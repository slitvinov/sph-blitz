...
set grid; set key 0.11, 0.0048
set xlabel "Perturbation"; set ylabel "Error rho";
...
set grid; set nokey
set xlabel "Perturbation"; set ylabel "Error U";
...
set grid; set nokey
set xlabel "Perturbation"; set ylabel "Error e";
